...
// export 하는 이유(PPTX, 2026-08-10): PPTX 내보내기도 학생용 트리를 만들어야 하는데, 이 로직을
// 복제하면 **정답 제거 규칙이 세상에 둘**이 되고 한쪽만 고쳐지면 다른 쪽이 조용히 샌다.
// 보안 임계 로직은 재사용한다. 본문은 한 줄도 바뀌지 않았다(export 키워드만 추가).
