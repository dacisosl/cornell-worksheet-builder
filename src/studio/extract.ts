...
- 원문에서 **문장 안에 섞여 있던** 수식은 그대로 두고, **한 줄을 통째로 차지하며 가운데(또는
  들여쓰기해) 크게 놓여 있던** 수식은 {"t":"math","latex":"...","display":true} 로 적는다.
  분수·극한·시그마처럼 세로로 큰 수식은 대개 display 다.
- 빈칸은 \\boxed{\\phantom{00}} 로 적는다 — 학생이 답을 써 넣을 네모다.
- 원문에서 **테두리·색 상자로 묶여 있던 글**(풀이 과정, 예시 풀이 등)은 stem 에 넣지 말고
  그 item 의 note 에 런 배열로 따로 적는다. 조판이 인용 상자로 다시 그린다.
...
{"items":[
  {"kind":"problem","no":"12","bbox":[0,0,1,0.5],"stem":[런...],"choices":[[런...],...],
   "subqs":[[런...],...],"note":[런...],"figures":[{"bbox":[0.6,0.1,0.4,0.3],"caption":"..."}],
   "uncertain":["..."],"tagLabel":"서술형"},
  {"kind":"concept","title":"...","bbox":[0,0.5,1,0.5],"body":[런...],"note":[런...]},
